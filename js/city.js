...
function first(preP, preC, VeryHuo, selectP, selectC) {
    a = 0;
    if (selectP == '01') { a = 1; tempoption = new Option('北京', '01', false, true); }
    ...
    if (selectP == '02') { a = 2; tempoption = new Option('深圳', '02', false, true); }
    ...
    if (selectP == '03') { a = 3; tempoption = new Option('上海', '03', false, true); }
    ...
    if (selectP == '04') { a = 4; tempoption = new Option('重庆', '04', false, true); }
    ...
    if (selectP == '05') { a = 5; tempoption = new Option('天津', '05', false, true); }
    ...
    if (selectP == '06') { a = 6; tempoption = new Option('广东', '06', false, true); }
    ...
    if (selectP == '07') { a = 7; tempoption = new Option('河北', '07', false, true); }
    ...
    if (selectP == '08') { a = 8; tempoption = new Option('山西', '08', false, true); }
    ...
    if (selectP == '09') { a = 9; tempoption = new Option('内蒙古', '09', false, true); }
    ...
    if (selectP == '10') { a = 10; tempoption = new Option('辽宁', '10', false, true); }
    ...
    if (selectP == '11') { a = 11; tempoption = new Option('吉林', '11', false, true); }
    ...
    if (selectP == '12') { a = 12; tempoption = new Option('黑龙江', '12', false, true); }
    ...
    if (selectP == '13') { a = 13; tempoption = new Option('江苏', '13', false, true); }
    ...
    if (selectP == '14') { a = 14; tempoption = new Option('浙江', '14', false, true); }
    ...
    if (selectP == '15') { a = 15; tempoption = new Option('安徽', '15', false, true); }
    ...
    if (selectP == '16') { a = 16; tempoption = new Option('福建', '16', false, true); }
    ...
    if (selectP == '17') { a = 17; tempoption = new Option('江西', '17', false, true); }
    ...
    if (selectP == '18') { a = 18; tempoption = new Option('山东', '18', false, true); }
    ...
    if (selectP == '19') { a = 19; tempoption = new Option('河南', '19', false, true); }
    ...
    if (selectP == '20') { a = 20; tempoption = new Option('湖北', '20', false, true); }
    ...
    if (selectP == '21') { a = 21; tempoption = new Option('湖南', '21', false, true); }
    ...
    if (selectP == '22') { a = 22; tempoption = new Option('广西', '22', false, true); }
    ...
    if (selectP == '23') { a = 23; tempoption = new Option('海南', '23', false, true); }
    ...
    if (selectP == '24') { a = 24; tempoption = new Option('四川', '24', false, true); }
    ...
    if (selectP == '25') { a = 25; tempoption = new Option('贵州', '25', false, true); }
    ...
    if (selectP == '26') { a = 26; tempoption = new Option('云南', '26', false, true); }
    ...
    if (selectP == '27') { a = 27; tempoption = new Option('西藏', '27', false, true); }
    ...
    if (selectP == '28') { a = 28; tempoption = new Option('陕西', '28', false, true); }
    ...
    if (selectP == '29') { a = 29; tempoption = new Option('甘肃', '29', false, true); }
    ...
    if (selectP == '30') { a = 30; tempoption = new Option('青海', '30', false, true); }
    ...
    if (selectP == '31') { a = 31; tempoption = new Option('宁夏', '31', false, true); }
    ...
    if (selectP == '32') { a = 32; tempoption = new Option('新疆', '32', false, true); }
    ...
    if (selectP == '33') { a = 33; tempoption = new Option('香港', '33', false, true); }
    ...
    if (selectP == '34') { a = 34; tempoption = new Option('澳门', '34', false, true); }
    ...
    if (selectP == '35') { a = 35; tempoption = new Option('台湾', '35', false, true); }
    ...
    if (cityid != '0') {
        ...
        for (i = 0; i < cityareaname[cityid - 1].length; i++) {
            if (selectC == cityareacode[cityid - 1][i]) { b = i + 1; tempoption = new Option(cityareaname[cityid - 1][i], cityareacode[cityid - 1][i], false, true); }
            else
